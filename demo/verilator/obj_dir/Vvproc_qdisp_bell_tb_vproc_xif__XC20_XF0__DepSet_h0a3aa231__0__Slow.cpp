...
VL_ATTR_COLD void Vvproc_qdisp_bell_tb_vproc_xif__XC20_XF0___ctor_var_reset(Vvproc_qdisp_bell_tb_vproc_xif__XC20_XF0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vvproc_qdisp_bell_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vvproc_qdisp_bell_tb_vproc_xif__XC20_XF0___ctor_var_reset\n"); );
    // Body
