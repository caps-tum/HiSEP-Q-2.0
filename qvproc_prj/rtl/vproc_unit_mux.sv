...
module vproc_unit_mux import vproc_pkg::*; #(
    ...
    generate
        for (genvar i = 0; i < UNIT_CNT; i++) begin
            if (UNITS[i]) begin
                ...
                /*
                 * Per-unit quantum trace wires stay local until we know which
                 * unit is active at the mux output. This mirrors how the mux
                 * already handles ordinary result traffic and keeps the new
                 * debug/export path structurally aligned with unit ordering.
                 */
                logic                                 quantum_valid; // quantum qvproc
                logic [4:0]                          quantum_op; // quantum qvproc
                logic [XIF_ID_W-1:0]                 quantum_instr_id; // quantum qvproc
                logic [4:0]                          quantum_vd_addr; // quantum qvproc
                ...
                logic                                quantum_last_cycle; // quantum qvproc
                logic                                quantum_vl_part_0; // quantum qvproc
                logic [4:0]                          quantum_res_vaddr; // quantum qvproc
                logic                                quantum_first_valid_result; // quantum qvproc
                logic                                quantum_has_valid_result; // quantum qvproc
                ...
                vproc_unit_wrapper #(
                    ...
                    .quantum_valid_o           ( quantum_valid              ), // quantum qvproc
                    .quantum_op_o              ( quantum_op                 ), // quantum qvproc
                    .quantum_instr_id_o        ( quantum_instr_id           ), // quantum qvproc
                    .quantum_vd_addr_o         ( quantum_vd_addr            ), // quantum qvproc
                    .quantum_elem1_o           ( quantum_elem1              ), // quantum qvproc
                    .quantum_elem2_o           ( quantum_elem2              ), // quantum qvproc
                    .quantum_elem3_o           ( quantum_elem3              ), // quantum qvproc
                    .quantum_lmul_o            ( quantum_lmul               ), // quantum qvproc
                    .quantum_emul_o            ( quantum_emul               ), // quantum qvproc
                    .quantum_count_mul_o       ( quantum_count_mul          ), // quantum qvproc
                    .quantum_first_cycle_o     ( quantum_first_cycle        ), // quantum qvproc
                    .quantum_last_cycle_o      ( quantum_last_cycle         ), // quantum qvproc
                    .quantum_vl_part_0_o       ( quantum_vl_part_0          ), // quantum qvproc
                    .quantum_res_vaddr_o       ( quantum_res_vaddr          ), // quantum qvproc
                    .quantum_first_valid_result_o ( quantum_first_valid_result ), // quantum qvproc
                    .quantum_has_valid_result_o   ( quantum_has_valid_result   ) // quantum qvproc
                );
                ...
                if (op_unit'(i) == UNIT_ELEM) begin
                    ...
                    assign quantum_valid_o       = quantum_valid; // quantum qvproc
                    assign quantum_op_o          = quantum_op; // quantum qvproc
                    assign quantum_instr_id_o    = quantum_instr_id; // quantum qvproc
                    assign quantum_vd_addr_o     = quantum_vd_addr; // quantum qvproc
                    assign quantum_elem1_o       = quantum_elem1; // quantum qvproc
                    assign quantum_elem2_o       = quantum_elem2; // quantum qvproc
                    assign quantum_elem3_o       = quantum_elem3; // quantum qvproc
                    assign quantum_lmul_o        = quantum_lmul; // quantum qvproc
                    assign quantum_emul_o        = quantum_emul; // quantum qvproc
                    assign quantum_count_mul_o   = quantum_count_mul; // quantum qvproc
                    assign quantum_first_cycle_o = quantum_first_cycle; // quantum qvproc
                    assign quantum_last_cycle_o  = quantum_last_cycle; // quantum qvproc
                    assign quantum_vl_part_0_o   = quantum_vl_part_0; // quantum qvproc
                    assign quantum_res_vaddr_o   = quantum_res_vaddr; // quantum qvproc
                    assign quantum_first_valid_result_o = quantum_first_valid_result; // quantum qvproc
                    assign quantum_has_valid_result_o   = quantum_has_valid_result; // quantum qvproc
                end
            end
        end
    endgenerate
    ...
    generate
        if (~UNITS[UNIT_ELEM]) begin
            /*
             * Pipelines without an ELEM instance cannot produce quantum trace
             * traffic, so the new sideband outputs are explicitly tied off.
             */
            assign quantum_valid_o       = 1'b0; // quantum qvproc
            assign quantum_op_o          = '0; // quantum qvproc
            assign quantum_instr_id_o    = '0; // quantum qvproc
            assign quantum_vd_addr_o     = '0; // quantum qvproc
            assign quantum_elem1_o       = '0; // quantum qvproc
            assign quantum_elem2_o       = '0; // quantum qvproc
            assign quantum_elem3_o       = '0; // quantum qvproc
            assign quantum_lmul_o        = cfg_lmul'('0); // quantum qvproc
            assign quantum_emul_o        = cfg_emul'('0); // quantum qvproc
            assign quantum_count_mul_o   = '0; // quantum qvproc
            assign quantum_first_cycle_o = '0; // quantum qvproc
            assign quantum_last_cycle_o  = '0; // quantum qvproc
            assign quantum_vl_part_0_o   = '0; // quantum qvproc
            assign quantum_res_vaddr_o   = '0; // quantum qvproc
            assign quantum_first_valid_result_o = '0; // quantum qvproc
            assign quantum_has_valid_result_o   = '0; // quantum qvproc
        end
    endgenerate
