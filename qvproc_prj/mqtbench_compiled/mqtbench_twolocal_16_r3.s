# Auto-generated HiSEP-Q assembly for mqtbench_twolocal_16_r3
# Source: mqtbench_twolocal_16_r3.qasm
# Batches: 19, max VL: 8
...
_start:
    ...
    qv.h     v3, v1, x7, 12    # FALLBACK (ry) x8
    ...
    addi a0, a0, 8
    vle8.v v1, (a0)         # v1 <- ctrl qubits
    qv.h     v3, v1, x7, 12    # FALLBACK (rz) x8
    addi x7, x0, 0x55      # refresh gate tag
    addi a0, a0, 8
    vle8.v v1, (a0)         # v1 <- ctrl qubits
    qv.h     v3, v1, x7, 12    # FALLBACK (rz) x8
