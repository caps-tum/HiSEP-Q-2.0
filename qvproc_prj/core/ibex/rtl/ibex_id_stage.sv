...
module ibex_id_stage #(
  ...
  logic        stall_wb;
  logic        flush_id;
  logic        instr_req_ctrl;
  logic        id_in_ready_ctrl;
  ...
  ibex_controller #(
    ...
    .BranchPredictor ( BranchPredictor )
      ...
      .id_in_ready_o                  ( id_in_ready_ctrl        ),
      .controller_run_o               ( controller_run          ),

      // to prefetcher
      .instr_req_o                    ( instr_req_ctrl          ),
      .pc_set_o                       ( pc_set_o                ),
  ...
  assign instr_req_o         = measure_pause_i ? 1'b0 : instr_req_ctrl;
  assign id_in_ready_o       = measure_pause_i ? 1'b0 : id_in_ready_ctrl;
